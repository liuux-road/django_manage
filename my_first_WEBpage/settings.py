"""
Django settings for my_first_WEBpage project.
...
ROOT_URLCONF = 'my_first_WEBpage.urls'
...
WSGI_APPLICATION = 'my_first_WEBpage.wsgi.application'
...
ASGI_APPLICATION = 'my_first_WEBpage.asgi.application'
CHANNEL_LAYERS = {
    "default": {
